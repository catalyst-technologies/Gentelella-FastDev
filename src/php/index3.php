...
$assets->enqueue_scripts('plugins', array(
    ...
    array('url' => 'plugins/jquery-sparkline/dist/jquery.sparkline.min.js'),
    array('url' => 'plugins/raphael/raphael.min.js'),
    array('url' => 'plugins/morris.js/morris.min.js'),
