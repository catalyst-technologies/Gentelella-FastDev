                        ...
                        <section class="content invoice">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <?php img('img/visa.png', 'Visa'); ?>
                                    <?php img('img/mastercard.png', 'Mastercard'); ?>
                                    <?php img('img/american-express.png', 'American Express'); ?>
                                    <?php img('img/paypal.png', 'Paypal'); ?>
