...
$assets->enqueue_styles('plugins', array(
    ...
    array('url' => 'plugins/google-code-prettify/bin/prettify.min.css'),
    array('url' => 'plugins/select2/dist/css/select2.min.css'),
    array('url' => 'plugins/switchery/dist/switchery.min.css'),
    array('url' => 'plugins/starrr/dist/starrr.css')
));
$assets->enqueue_scripts('plugins', array(
    ...
    array('url' => 'plugins/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js'),
    array('url' => 'plugins/jquery.hotkeys/jquery.hotkeys.js'),
    array('url' => 'plugins/google-code-prettify/src/prettify.js'),
    array('url' => 'plugins/jquery.tagsinput/src/jquery.tagsinput.js'),
    array('url' => 'plugins/switchery/dist/switchery.min.js'),
    array('url' => 'plugins/select2/dist/js/select2.full.min.js'),
    array('url' => 'plugins/parsleyjs/dist/parsley.js'),
    array('url' => 'plugins/autosize/dist/autosize.min.js'),
    array('url' => 'plugins/devbridge-autocomplete/dist/jquery.autocomplete.min.js'),
    array('url' => 'plugins/starrr/dist/starrr.js')
));
