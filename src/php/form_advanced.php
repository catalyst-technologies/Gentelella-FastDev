...
$assets->enqueue_styles('plugins', array(
    array('url' => 'plugins/normalize-css/normalize.css'),
    array('url' => 'plugins/ion.rangeSlider/css/ion.rangeSlider.css'),
    array('url' => 'plugins/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css'),
    array('url' => 'plugins/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css'),
    array('url' => 'plugins/cropper/dist/cropper.min.css')
));
$assets->enqueue_scripts('plugins', array(
    array('url' => 'js/moment/moment.min.js'),
    array('url' => 'js/datepicker/daterangepicker.js'),
    array('url' => 'plugins/ion.rangeSlider/js/ion.rangeSlider.min.js'),
    array('url' => 'plugins/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js'),
    array('url' => 'plugins/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js'),
    array('url' => 'plugins/jquery-knob/dist/jquery.knob.min.js'),
    array('url' => 'plugins/cropper/dist/cropper.min.js')
));
define('page_title','Form Advanced');
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="img-container">
                                <?php get_image('img/cropper.jpg',false,'','Picture'); ?>
                            </div>
                        </div>
                        <div class="col-md-3">
