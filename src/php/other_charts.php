...
$assets->enqueue_scripts('plugins', array(
    ...
    array('url' => 'plugins/jqvmap/dist/maps/jquery.vmap.usa.js'),
    array('url' => 'plugins/jqvmap/examples/js/jquery.vmap.sampledata.js'),
    array('url' => 'plugins/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js')
));
define('page_title', 'Other Charts');
